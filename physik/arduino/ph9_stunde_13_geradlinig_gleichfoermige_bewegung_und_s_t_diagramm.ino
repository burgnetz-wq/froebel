/*
  Klasse 9 – Geradlinig gleichförmige Bewegung und s-t-Diagramm
  Funktion: Weg-Zeit-Daten mit HC-SR04 protokollieren
  Sensor/Aktor: HC-SR04
  Messgröße/Rohwert: Zeit in ms und Abstand in cm
