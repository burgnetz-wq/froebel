/*
  Klasse 9 – Beschleunigung als Änderung der Geschwindigkeit
  Funktion: Beschleunigungswerte mit MPU6050 als Rohdaten erfassen
  Sensor/Aktor: MPU6050
  Messgröße/Rohwert: Beschleunigungs-Rohwerte ax, ay, az; nur nach Kalibrierung in m/s²
